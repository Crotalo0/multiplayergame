...
public class ClientTwo {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ClientTwo.class);
  private final Socket socket;
  private final BufferedReader serverIn;
  private final BufferedReader userIn;
  private final PrintWriter serverOut;

  public ClientTwo(String address, int port) throws IOException {
  ...
  public static void main(String[] args) throws IOException {
    ...
    ClientTwo client = new ClientTwo(serverAddress, port);
    client.clientLogic();
  }
